...
procedure FillParamsAir;
procedure FillParamsFoil;
...
begin
  ...
  SibrParams[1].min:= -1.1;
  SibrParams[1].max:= 1.1;
  ...
  SibrParams[3].min:= -1.1;
  SibrParams[3].max:= 1.1;
  SibrParams[3].stdDev:= 0.1;
  SibrParams[3].k:= 5;
  SibrParams[3].m:= 4;

  SibrParams[4].name:= 'AY';
  SibrParams[4].min:= -1.1;
  SibrParams[4].max:= 1.1;
  ...
  SibrParams[25].min:= 0;
  SibrParams[25].max:= 0.15;
  SibrParams[25].stdDev:= 0.02;
  SibrParams[25].k:= 7;
  SibrParams[25].m:= 3;

  SibrParams[26].name:= 'I_5RV';
  SibrParams[26].min:= 0.1;
  SibrParams[26].max:= 0.35;
  ...
  SibrParams[30].max:= 0.4;
  SibrParams[30].stdDev:= 0.02;
  SibrParams[30].k:= 7;
  SibrParams[30].m:= 3;

  SibrParams[31].name:= 'AR1T0F1';
  SibrParams[31].min:= 0.001;
  SibrParams[31].max:= 1;
  SibrParams[31].stdDev:= 0.2;
  SibrParams[31].k:= 10;
  SibrParams[31].m:= 3;

  SibrParams[32].name:= 'AR2T0F1';
  SibrParams[32].min:= 0.001;
  SibrParams[32].max:= 1;
  SibrParams[32].stdDev:= 0.2;
  SibrParams[32].k:= 10;
  SibrParams[32].m:= 3;

  SibrParams[33].name:= 'AR1T0F2';
  SibrParams[33].min:= 0.001;
  SibrParams[33].max:= 1;
  SibrParams[33].stdDev:= 0.2;
  SibrParams[33].k:= 10;
  SibrParams[33].m:= 3;

  SibrParams[34].name:= 'AR2T0F2';
  SibrParams[34].min:= 0.001;
  SibrParams[34].max:= 1;
  SibrParams[34].stdDev:= 0.2;
  SibrParams[34].k:= 10;
  SibrParams[34].m:= 3;
  ...
  SibrParams[35].min:= 3;
  SibrParams[35].max:= 6;
  SibrParams[35].stdDev:= 0.02;
  SibrParams[35].k:= 10;
  SibrParams[35].m:= 3;

  SibrParams[36].name:= 'AR2T1F1';
  SibrParams[36].min:= 4;
  SibrParams[36].max:= 12;
  SibrParams[36].stdDev:= 0.02;
  SibrParams[36].k:= 10;
  SibrParams[36].m:= 3;
  ...
  SibrParams[37].min:= 2;
  SibrParams[37].max:= 8;
  SibrParams[37].stdDev:= 0.02;
  SibrParams[37].k:= 10;
  SibrParams[37].m:= 3;

  SibrParams[38].name:= 'AR2T1F2';
  SibrParams[38].min:= 7;
  SibrParams[38].max:= 15;
  SibrParams[38].stdDev:= 0.02;
  SibrParams[38].k:= 10;
  SibrParams[38].m:= 3;

  SibrParams[39].name:= 'AR1T2F1';
  SibrParams[39].min:= 6;
  SibrParams[39].max:= 12;
  SibrParams[39].stdDev:= 0.02;
  SibrParams[39].k:= 10;
  SibrParams[39].m:= 3;
  ...
  SibrParams[40].min:= 4;
  SibrParams[40].max:= 6;
  SibrParams[40].stdDev:= 0.02;
  SibrParams[40].k:= 10;
  SibrParams[40].m:= 3;

  SibrParams[41].name:= 'AR1T2F2';
  SibrParams[41].min:= 10;
  SibrParams[41].max:= 15;
  SibrParams[41].stdDev:= 0.02;
  SibrParams[41].k:= 10;
  SibrParams[41].m:= 3;

  SibrParams[42].name:= 'AR2T2F2';
  SibrParams[42].min:= 5;
  SibrParams[42].max:= 10;
  SibrParams[42].stdDev:= 0.02;
  SibrParams[42].k:= 10;
  SibrParams[42].m:= 3;

  SibrParams[43].name:= 'AR1T3F1';
  SibrParams[43].min:= 5;
  SibrParams[43].max:= 10;
  SibrParams[43].stdDev:= 0.02;
  SibrParams[43].k:= 10;
  SibrParams[43].m:= 3;

  SibrParams[44].name:= 'AR2T3F1';
  SibrParams[44].min:= 8;
  SibrParams[44].max:= 12;
  SibrParams[44].stdDev:= 0.02;
  SibrParams[44].k:= 10;
  SibrParams[44].m:= 3;

  SibrParams[45].name:= 'AR1T3F2';
  SibrParams[45].min:= 6;
  SibrParams[45].max:= 12;
  SibrParams[45].stdDev:= 0.02;
  SibrParams[45].k:= 10;
  SibrParams[45].m:= 3;

  SibrParams[46].name:= 'AR2T3F2';
  SibrParams[46].min:= 8;
  SibrParams[46].max:= 15;
  SibrParams[46].stdDev:= 0.02;
  SibrParams[46].k:= 10;
  SibrParams[46].m:= 3;

  SibrParams[47].name:= 'PR1T0F1';
  SibrParams[47].min:= -1.6;
  SibrParams[47].max:= 1.6;
  SibrParams[47].stdDev:= 1.5;
  SibrParams[47].k:= 7;
  SibrParams[47].m:= 6;

  SibrParams[48].name:= 'PR2T0F1';
  SibrParams[48].min:= -1.6;
  SibrParams[48].max:= 1.6;
  SibrParams[48].stdDev:= 1.5;
  SibrParams[48].k:= 7;
  SibrParams[48].m:= 6;

  SibrParams[49].name:= 'PR1T0F2';
  SibrParams[49].min:= -1.6;
  SibrParams[49].max:= 1.6;
  SibrParams[49].stdDev:= 1.5;
  SibrParams[49].k:= 7;
  SibrParams[49].m:= 6;

  SibrParams[50].name:= 'PR2T0F2';
  SibrParams[50].min:= -1.6;
  SibrParams[50].max:= 1.6;
  SibrParams[50].stdDev:= 1.5;
  SibrParams[50].k:= 7;
  SibrParams[50].m:= 6;

  SibrParams[51].name:= 'PR1T1F1';
  SibrParams[51].min:= -1.6;
  SibrParams[51].max:= 1.6;
  SibrParams[51].stdDev:= 0.2;
  SibrParams[51].k:= 7;
  SibrParams[51].m:= 6;

  SibrParams[52].name:= 'PR2T1F1';
  SibrParams[52].min:= -1.6;
  SibrParams[52].max:= 1.6;
  SibrParams[52].stdDev:= 0.2;
  SibrParams[52].k:= 7;
  SibrParams[52].m:= 6;

  SibrParams[53].name:= 'PR1T1F2';
  SibrParams[53].min:= -1.6;
  SibrParams[53].max:= 1.6;
  SibrParams[53].stdDev:= 0.2;
  SibrParams[53].k:= 7;
  SibrParams[53].m:= 6;

  SibrParams[54].name:= 'PR2T1F2';
  SibrParams[54].min:= -1.6;
  SibrParams[54].max:= 1.6;
  SibrParams[54].stdDev:= 0.2;
  SibrParams[54].k:= 7;
  SibrParams[54].m:= 6;

  SibrParams[55].name:= 'PR1T2F1';
  SibrParams[55].min:= -1.6;
  SibrParams[55].max:= 1.6;
  SibrParams[55].stdDev:= 0.2;
  SibrParams[55].k:= 7;
  SibrParams[55].m:= 6;

  SibrParams[56].name:= 'PR2T2F1';
  SibrParams[56].min:= -1.6;
  SibrParams[56].max:= 1.6;
  SibrParams[56].stdDev:= 0.2;
  SibrParams[56].k:= 7;
  SibrParams[56].m:= 6;

  SibrParams[57].name:= 'PR1T2F2';
  SibrParams[57].min:= -1.6;
  SibrParams[57].max:= 1.6;
  SibrParams[57].stdDev:= 0.2;
  SibrParams[57].k:= 7;
  SibrParams[57].m:= 6;

  SibrParams[58].name:= 'PR2T2F2';
  SibrParams[58].min:= -1.6;
  SibrParams[58].max:= 1.6;
  SibrParams[58].stdDev:= 0.2;
  SibrParams[58].k:= 7;
  SibrParams[58].m:= 6;

  SibrParams[59].name:= 'PR1T3F1';
  SibrParams[59].min:= -1.6;
  SibrParams[59].max:= 1.6;
  SibrParams[59].stdDev:= 0.2;
  SibrParams[59].k:= 7;
  SibrParams[59].m:= 6;

  SibrParams[60].name:= 'PR2T3F1';
  SibrParams[60].min:= -1.6;
  SibrParams[60].max:= 1.6;
  SibrParams[60].stdDev:= 0.2;
  SibrParams[60].k:= 7;
  SibrParams[60].m:= 6;

  SibrParams[61].name:= 'PR1T3F2';
  SibrParams[61].min:= -1.6;
  SibrParams[61].max:= 1.6;
  SibrParams[61].stdDev:= 0.2;
  SibrParams[61].k:= 7;
  SibrParams[61].m:= 6;

  SibrParams[62].name:= 'PR2T3F2';
  SibrParams[62].min:= -1.6;
  SibrParams[62].max:= 1.6;
  SibrParams[62].stdDev:= 0.2;
  SibrParams[62].k:= 7;
  SibrParams[62].m:= 6;
end;
